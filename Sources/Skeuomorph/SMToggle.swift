...
public struct SkeuomorphToggleStyle: ToggleStyle {
    ...
    public func makeBody(configuration: Self.Configuration) -> some View {
        HStack {
            ...
            InternalSkeuomorphToggle(isOn: configuration.$isOn, shouldShowBlueBackground: configuration.isOn)
        }
    }
    ...
    struct InternalSkeuomorphToggle: View {
        ...
        init(isOn: Binding<Bool>, shouldShowBlueBackground: Bool) {
            self._isOn = isOn
            self._shouldShowBlueBackground = State(initialValue: shouldShowBlueBackground)
        }
