...
struct SMToggle: ToggleStyle {
    ...
    @Binding var viewDisplacement: CGSize
    ...
    @Binding var shouldShowBlueBackground: Bool
    ...
    func toggle(configuration: Self.Configuration) -> some View {
        ZStack {
            ...
            Text("OFF")
                ...
                .offset(x: configuration.isOn ? 70 : 10)
            ...
            RoundedRectangle(cornerRadius: 16)
                ...
                .frame(width: 92, height: 32)
                .offset(x: configuration.isOn ? 0 : -60)
                .offset(x: viewDisplacement.width)
                .opacity(self.shouldShowBlueBackground ? 1 : 0)
            ...
            Text("ON")
                ...
                .offset(x: configuration.isOn ? -10 : -70)
                .offset(x: viewDisplacement.width)
            ...
            .highPriorityGesture(
                ...
                .onEnded { value in
                    withAnimation(.easeInOut(duration: 0.25)) {
                        ...
                        if !configuration.isOn && value.translation.width > 30 || configuration.isOn && value.translation.width < -30 {
                            configuration.$isOn.wrappedValue.toggle()
                        }
